module Lolcommits
  class CaptureWindowsAnimated < Capturer
    def capture
      ...
      # capture the raw video with ffmpeg vfwcap
      system_call "ffmpeg -v quiet -y -f vfwcap -video_size 320x240 -i #{capture_device_string} -t #{capture_duration} \"#{video_location}\" > NUL"
